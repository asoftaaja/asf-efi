...
#define CMD_WRITE_SHIFT_CUT   0x17 // PC→AVR: 7 bytes (enabled uint8 + duration_ms, min_rpm, lockout_ms as uint16 BE)
#define CMD_READ_SHIFT_CUT    0x18 // PC→AVR: no payload; AVR→PC: 7 bytes same layout
